...
public class testUtil extends TestBase {
	...
	// in this file ( Screenshots captured and creation of zip file code is here) 
...
/*	
    try {
    	...
    	FileUtils.copyFile(scrFile, new File("C:\\WebDrivers\\TestNGListenersOnFailure\\Screenshot "+mailscreenshotpath));
	} catch (IOException e) {
